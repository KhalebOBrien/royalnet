...
<head>
    ...
    <title>Pay Users - Royal Network</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center">
                ...
                <div class="sidebar-brand-text mx-3">Royal Network
                    Admin
                </div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="post-task.html">
                    <span>Post Tasks</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="pay.html">
                    <span>Pay Users</span>
                </a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                                  ...
                                  <li class="nav-item"> 
                                    <div class="btn-group dropdown">
                                      <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                        <span><i>Admin name</i></span>
                                        <i class="bi bi-person" style="width: 500px;"></i>
                                      </button>
                                      <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                                        <li><a class="dropdown-item" href="admin-account.html">My Account</a></li>
                ...
                <div class="container-fluid">
                            <!-- List of all users that placed withdrawal -->
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary"> Users that placed withdrawal</h6>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td><strike>N</strike><span>1000</span></td>
                                <td>UBA, 1234567890, John jane</td>
                                <td>social media</td>
