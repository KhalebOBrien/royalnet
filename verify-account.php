...
<head>
    ...
    <title>Account Verification - <?= Helpers::APPLICATION_NAME ?></title>
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="text-center form-wrap col-sm-12 col-md-10 col-lg-6">
            <p>Your account have been verified! You may now <a href="login">login</a></p>
        </div>
